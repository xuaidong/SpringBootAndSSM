...
out.print(path+"111<br/>");
	String basePath = request.getScheme() + "://"
			+ request.getServerName() + ":" + request.getServerPort()
			+ path + "/";
	out.print(basePath+"222<br/>");
%>
<html>
<head>
...
$(document).ready(function(){ 
	...
	$("#del").click(function(){
		alert("删");
		$.post(path+"/stuController/delStuByName",{"sName" : "张三"},function(data){
					alert(data);
				},"json");
		});
	...
	$("#selOne").click(function(){
		alert("查1");
		$.post(path+"/stuController/findStuById",{"sId" : 2},function(data){
			alert(data);
		},"json");
	});
	...
	$("#selAll").click(function(){
		alert("查All");
		$.post(path+"/stuController/findAllStus",{},function(data){
			$("#res").html("");
